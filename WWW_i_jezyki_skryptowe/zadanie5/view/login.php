...
<nav class="menu">
   ...
   <?php
      ...
      if($_SESSION['TryReg']) {?><a href="?cmd=login">Logowanie</a><?php } ?></center>
</nav>
<?php if($_SESSION['TryLogin']) { ?>
   <section id="login">
      ...
      <input type="text" name="nazwaLogowania" placeholder="Nazwa logowania" pattern="[A-Za-z0-9\-]*" autofocus \><br />
...
<?php } else {?>
   <section id="register">
      ...
      <input type="text" name="nazwaRejestracji" placeholder="Nazwa logowania (dozwolone są tylko: litery, cyfry i znak '-')" pattern="[A-Za-z0-9\-]*" autofocus \><br />
      ...
      <div style="text-align:center;">
         <img src="?generateCaptha=1" onclick="this.src='?generateCaptha='+Math.random();">
         </br>kliknij w obrazek aby zmienić wyświetlany kod</br>
         <input type="text" name="captcha" placeholder="Wpisz kod z obrazka" style="width:200px;"  \>
      </div>
