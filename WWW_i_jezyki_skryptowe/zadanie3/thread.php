    ...
    <form action="./thread.php?id=<?=$_GET['id']?>" method="POST">
        <?php if (isset($_GET['action']) and isset($_GET['post'])) : ?>
            <?php if ($_GET['action'] == 'edit') : ?>
                ...
                <center><textarea id="content" name="post_content" rows="10" cols="40" required><?=$content?></textarea><br><br></center>
        ...
        <?php else : ?>
            ...
            <center><textarea name="post_content"  rows="10" cols="40" placeholder="TREŚĆ KOMENTARZA" required></textarea><br><br></center>
            <center> <input type="submit" value="DODAJ KOMENTARZ"></center>
        <?php endif; ?>
